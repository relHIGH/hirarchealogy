  ...
  <div class="pages-container" id="pagesContainer">
    ...
    <div class="page" id="page-0">
      <div class="intro-layout">
        <div class="intro-left">
          ...
          <div class="char-bio">
            <p>汴梁瓦舍中的琵琶艺人。北宋的东京繁华冠绝天下，勾栏瓦舍夜夜笙歌。她的曲子讲述着市井故事。</p>
          </div>
    ...
    <div class="page" id="page-1" style="display:none">
      <div class="chapter-layout">
        ...
        <div class="text-block">
          <p>这是柳边声故事的第1章内容。在这里，你可以了解宋时期汴梁瓦舍艺人的生活与工作。</p>
          <div class="clickable-text" onclick="collectNode('汴梁', '戏', this)">
      ...
      <div class="chapter-layout">
        ...
        <div class="dialogue-box">
          ...
          <div class="dialogue-content">
            ...
            <div class="clickable-item" onclick="collectRelic('琵琶', this)">
              <span class="pulse-dot"></span>
              <strong>"琵琶"</strong>
            </div>
          </div>
    ...
    <div class="page" id="page-3" style="display:none">
      <div class="chapter-layout">
        ...
        <div class="text-block">
          <p>这是柳边声故事的第2章内容。在这里，你可以了解宋时期汴梁瓦舍艺人的生活与工作。</p>
          <div class="clickable-text" onclick="collectNode('琵琶', '戏', this)">
            <span class="pulse-dot"></span>
    ...
    <div class="page" id="page-4" style="display:none">
      <div class="chapter-layout">
        ...
        <div class="dialogue-box">
          ...
          <div class="dialogue-content">
            <span class="speaker">历史人物</span>
            <div class="clickable-item" onclick="collectRelic('戏服', this)">
              <span class="pulse-dot"></span>
              <strong>"戏服"</strong>
            </div>
          </div>
    ...
    <div class="page" id="page-5" style="display:none">
      <div class="chapter-layout">
        ...
        <div class="text-block">
          <p>这是柳边声故事的第3章内容。在这里，你可以了解宋时期汴梁瓦舍艺人的生活与工作。</p>
          <div class="clickable-text" onclick="collectNode('勾栏', '戏', this)">
            <span class="pulse-dot"></span>
    ...
    <div class="page" id="page-6" style="display:none">
      <div class="chapter-layout">
        ...
        <div class="dialogue-box">
          ...
          <div class="dialogue-content">
            <span class="speaker">历史人物</span>
            <div class="clickable-item" onclick="collectRelic('话本', this)">
              <span class="pulse-dot"></span>
              <strong>"话本"</strong>
            </div>
          </div>
    ...
    <div class="page" id="page-7" style="display:none">
      <div class="chapter-layout">
        ...
        <div class="text-block">
          <p>这是柳边声故事的第4章内容。在这里，你可以了解宋时期汴梁瓦舍艺人的生活与工作。</p>
          <div class="clickable-text" onclick="collectNode('说书', '戏', this)">
            <span class="pulse-dot"></span>
    ...
    <div class="page" id="page-8" style="display:none">
      <div class="chapter-layout">
        ...
        <div class="dialogue-box">
          ...
          <div class="dialogue-content">
            <span class="speaker">历史人物</span>
            <div class="clickable-item" onclick="collectRelic('铜锣', this)">
              <span class="pulse-dot"></span>
              <strong>"铜锣"</strong>
            </div>
          </div>
...
function updateCollectionPanel() {
  ...
  var allNodes = ['汴梁', '瓦舍', '琵琶', '东京', '勾栏', '曲子', '说书', '杂剧', '词曲', '傀儡戏'];
