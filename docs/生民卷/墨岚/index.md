  ...
  <div class="pages-container" id="pagesContainer">
    ...
    <div class="page" id="page-0">
      <div class="intro-layout">
        <div class="intro-left">
          ...
          <div class="char-bio">
            <p>任职于西夏黑水城，这座沙漠中的军镇是丝绸之路北道的要冲。她精通西夏文和汉文，负责抄写文书、管理档案。</p>
          </div>
    ...
    <div class="page" id="page-1" style="display:none">
      <div class="chapter-layout">
        ...
        <div class="text-block">
          <p>这是细封简兰故事的第1章内容。在这里，你可以了解西夏时期黑水城文书吏的生活与工作。</p>
          <div class="clickable-text" onclick="collectNode('西夏', '感', this)">
      ...
      <div class="chapter-layout">
        ...
        <div class="dialogue-box">
          ...
          <div class="dialogue-content">
            ...
            <div class="clickable-item" onclick="collectRelic('西夏文木活字', this)">
              <span class="pulse-dot"></span>
              <strong>"西夏文木活字"</strong>
            </div>
          </div>
        </div>
        <button class="nav-btn" onclick="nextPage()">下一页 →</button>
    ...
    <div class="page" id="page-3" style="display:none">
      <div class="chapter-layout">
        ...
        <div class="text-block">
          <p>这是细封简兰故事的第2章内容。在这里，你可以了解西夏时期黑水城文书吏的生活与工作。</p>
          <div class="clickable-text" onclick="collectNode('文书', '感', this)">
            <span class="pulse-dot"></span>
    ...
    <div class="page" id="page-4" style="display:none">
      <div class="chapter-layout">
        ...
        <div class="dialogue-box">
          ...
          <div class="dialogue-content">
            <span class="speaker">历史人物</span>
            <div class="clickable-item" onclick="collectRelic('汉文文书', this)">
              <span class="pulse-dot"></span>
              <strong>"汉文文书"</strong>
            </div>
          </div>
    ...
    <div class="page" id="page-5" style="display:none">
      <div class="chapter-layout">
        ...
        <div class="text-block">
          <p>这是细封简兰故事的第3章内容。在这里，你可以了解西夏时期黑水城文书吏的生活与工作。</p>
          <div class="clickable-text" onclick="collectNode('西夏文', '感', this)">
            <span class="pulse-dot"></span>
    ...
    <div class="page" id="page-6" style="display:none">
      <div class="chapter-layout">
        ...
        <div class="dialogue-box">
          ...
          <div class="dialogue-content">
            <span class="speaker">历史人物</span>
            <div class="clickable-item" onclick="collectRelic('藏文经卷', this)">
              <span class="pulse-dot"></span>
              <strong>"藏文经卷"</strong>
            </div>
          </div>
    ...
    <div class="page" id="page-7" style="display:none">
      <div class="chapter-layout">
        ...
        <div class="text-block">
          <p>这是细封简兰故事的第4章内容。在这里，你可以了解西夏时期黑水城文书吏的生活与工作。</p>
          <div class="clickable-text" onclick="collectNode('额济纳', '感', this)">
            <span class="pulse-dot"></span>
    ...
    <div class="page" id="page-8" style="display:none">
      <div class="chapter-layout">
        ...
        <div class="dialogue-box">
          ...
          <div class="dialogue-content">
            <span class="speaker">历史人物</span>
            <div class="clickable-item" onclick="collectRelic('铜印', this)">
              <span class="pulse-dot"></span>
              <strong>"铜印"</strong>
            </div>
          </div>
...
function updateCollectionPanel() {
  ...
  var allNodes = ['西夏', '黑水城', '文书', '档案', '西夏文', '汉文', '额济纳', '回鹘', '吐蕃', '蒙古'];
